    ...
    return {
            ...
            user.save(function(err) {
                ...
                /*else
                {
                    MeanUser.events.publish({
                        ...
                        name: user.username,
                        url: config.hostname + '/users/' + user._id
                    });
                    res.json(user);
                }*/
        ...
        show: function(req, res) {
            ...
            MeanUser.events.publish({
                ...
                url: config.hostname + '/users/' + req.user._id
            });
        ...
        all: function(req, res) {
            var query = req.acl.query('User');

            query.find({}).sort('-username').populate('user', 'name username').exec(function(err, users) {
                if (err) {
                    return res.status(500).json({
