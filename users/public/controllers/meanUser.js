...
angular.module('mean.users')
  ...
  .controller('UpdateController', ['$rootScope', 'MeanUser', '$stateParams',
    function($rootScope, MeanUser, $stateParams){
      var vm = this;
      ...
      vm.user._id = $stateParams.userId;

      vm.findOne = function() {
        MeanUser.get(vm.user._id, function(req, res){
          vm.user = res;
        });
      ...
      $rootScope.$on('updatefailed', function(){
        vm.updateError = MeanUser.updateError;
      });
    }
  ])
